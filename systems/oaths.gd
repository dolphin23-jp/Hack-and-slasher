...
const CHOICES={
 "dance":{"flow":{"name":"流転","stats":{"haste":.08},"text":"速度を伸ばして連携回数を増やす。"},"impact":{"name":"重奏","stats":{"crit_damage":.18},"text":"一撃ごとの決定力を伸ばす。"}},
 "arcane":{"focus":{"name":"収束","stats":{"magic":.12},"text":"魔撃そのものを強化する。"},"reserve":{"name":"循環","stats":{"cdr":.06},"text":"技能の再使用を早める。"}},
 "fortress":{"bulwark":{"name":"不落","stats":{"shield_max":18.0},"text":"障壁容量を大きくする。"},"plate":{"name":"重装","stats":{"armor":8.0},"text":"常時防御を高める。"}},
 "flame":{"smolder":{"name":"残火","stats":{"skill":.12},"text":"継続火力と技能を伸ばす。"},"burst":{"name":"爆ぜ火","stats":{"crit_damage":.18},"text":"瞬間火力へ寄せる。"}},
 "storm":{"voltage":{"name":"高電圧","stats":{"pierce":.12},"text":"単体への貫撃を伸ばす。"},"cascade":{"name":"連鎖","stats":{"haste":.08},"text":"手数を増やして雷撃機会を作る。"}},
 "seek":{"hunter":{"name":"鑑定眼","stats":{"rarity_find":.18},"text":"高レア発見へ寄せる。"},"smith":{"name":"鍛冶師","stats":{"material_find":.20,"salvage":.15},"text":"素材循環へ寄せる。"}}}
const CAPSTONES={
