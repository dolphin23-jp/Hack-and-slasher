...
**Phase 4 — Enemy / Boss Expansion:** 新雑魚3種、Champion、Mini Boss、Forge/Thorn Boss、Elite affix拡張、Boss固有報酬、複数Boss対応HUD/予告表示、拡張敵図鑑を追加。既存の12部屋構造は維持し、ルート再設計はPhase 5へ分離。[Phase 4戦闘仕様](docs/PHASE4_ENCOUNTERS.md)。
